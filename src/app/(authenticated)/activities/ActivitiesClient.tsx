        ...
        return (
          ...
          >
            ...
            <button
              ...
              className="w-full p-6 text-left transition-colors hover:bg-zinc-50 dark:hover:bg-zinc-800"
            >
            ...
            {/* Expanded Details */}
            {isExpanded && (
              <div className="border-t border-zinc-200 bg-zinc-50 p-6 dark:border-zinc-700 dark:bg-zinc-800">
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4 border-t border-zinc-200 pt-4 dark:border-zinc-700">
                    <div className="rounded-lg bg-white p-3 dark:bg-zinc-900">
                      <p className="text-xs text-zinc-500 dark:text-zinc-400">Total Work Time</p>
                      <p className="mt-1 text-lg font-semibold text-zinc-900 dark:text-white">
                        {formatDuration(workout.totalWorkTime)}
                      </p>
                    </div>
                    <div className="rounded-lg bg-white p-3 dark:bg-zinc-900">
                      <p className="text-xs text-zinc-500 dark:text-zinc-400">Total Rest Time</p>
                      <p className="mt-1 text-lg font-semibold text-zinc-900 dark:text-white">
